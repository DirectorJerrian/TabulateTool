"use strict";
cc._RF.push(module, '119d0XylExEkIoz60YkLEyL', 'IET25_3');
// script/团队25人/IET25_3.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid3'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect3'); //读取数据
        if (temp2 != null) {

"use strict";
cc._RF.push(module, '2eb17f5MSVHs5y1ptHoLuyb', 'IET25_17');
// script/团队25人/IET25_17.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid17'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect17'); //读取数据
        if (temp2 != null) {

"use strict";
cc._RF.push(module, '4a360KSXZBE2b4pF22MHTAE', 'IETy10_1');
// script/类别10人/IETy10_1.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('mid1'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('mselect1'); //读取数据
        if (temp2 != null) {

"use strict";
cc._RF.push(module, 'a1d0eowPEBOZZHBB9uopGt2', 'IET10_4');
// script/团队10人/IET10_4.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('id4'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('select4'); //读取数据
        if (temp2 != null) {

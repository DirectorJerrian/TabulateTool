"use strict";
cc._RF.push(module, 'b701adJSEtGybBVlI/mIMra', 'IET25_19');
// script/团队25人/IET25_19.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid19'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect19'); //读取数据
        if (temp2 != null) {

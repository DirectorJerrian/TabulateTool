"use strict";
cc._RF.push(module, 'de346yzI9ROPI5sm5jBUsxK', 'IET10_2');
// script/团队10人/IET10_2.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('id2'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('select2'); //读取数据
        if (temp2 != null) {

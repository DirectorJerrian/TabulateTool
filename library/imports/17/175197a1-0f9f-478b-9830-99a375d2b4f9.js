"use strict";
cc._RF.push(module, '17519ehD59Hi5gwmaN10rT5', 'IET10_5');
// script/团队10人/IET10_5.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('id5'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('select5'); //读取数据
        if (temp2 != null) {

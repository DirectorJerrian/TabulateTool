"use strict";
cc._RF.push(module, 'b4bceE0YYJFW5GO5XXcvsOr', 'IETy10_16');
// script/类别10人/IETy10_16.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('mid16'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('mselect16'); //读取数据
        if (temp2 != null) {

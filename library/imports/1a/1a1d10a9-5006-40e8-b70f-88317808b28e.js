"use strict";
cc._RF.push(module, '1a1d1CpUAZA6LcPiDF4CLKO', 'IETy10_11');
// script/类别10人/IETy10_11.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('mid11'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('mselect11'); //读取数据
        if (temp2 != null) {

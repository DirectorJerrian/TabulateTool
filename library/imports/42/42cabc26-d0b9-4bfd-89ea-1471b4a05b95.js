"use strict";
cc._RF.push(module, '42cabwm0LlL/YnqFHG0oFuV', 'IET25_9');
// script/团队25人/IET25_9.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid9'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect9'); //读取数据
        if (temp2 != null) {

"use strict";
cc._RF.push(module, 'ba5e0hVPGNLK7lB3U2A4uRQ', 'IETy10_3');
// script/类别10人/IETy10_3.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('mid3'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('mselect3'); //读取数据
        if (temp2 != null) {

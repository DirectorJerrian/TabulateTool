"use strict";
cc._RF.push(module, 'ef97464tUNFCYbZEL7vuwvg', 'IET25_22');
// script/团队25人/IET25_22.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid22'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect22'); //读取数据
        if (temp2 != null) {

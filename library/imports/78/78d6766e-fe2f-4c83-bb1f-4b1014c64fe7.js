"use strict";
cc._RF.push(module, '78d67Zu/i9Mg7sfSxAUxk/n', 'IETy10_14');
// script/类别10人/IETy10_14.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('mid14'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('mselect14'); //读取数据
        if (temp2 != null) {

"use strict";
cc._RF.push(module, '97b47ybX4dCZ6OX+LLbsnt5', 'IET25_8');
// script/团队25人/IET25_8.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid8'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect8'); //读取数据
        if (temp2 != null) {

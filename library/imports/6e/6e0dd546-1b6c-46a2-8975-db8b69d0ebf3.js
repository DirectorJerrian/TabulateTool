"use strict";
cc._RF.push(module, '6e0ddVGG2xGool124tp0Ovz', 'IET25_2');
// script/团队25人/IET25_2.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid2'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect2'); //读取数据
        if (temp2 != null) {

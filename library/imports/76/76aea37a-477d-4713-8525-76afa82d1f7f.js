"use strict";
cc._RF.push(module, '76aeaN6R31HE4Uldq+oLR9/', 'IET10_6');
// script/团队10人/IET10_6.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('id6'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('select6'); //读取数据
        if (temp2 != null) {

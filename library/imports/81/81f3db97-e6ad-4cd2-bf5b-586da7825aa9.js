"use strict";
cc._RF.push(module, '81f3duX5q1M0r9bWG2nglqp', 'IETy10_8');
// script/类别10人/IETy10_8.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('mid8'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('mselect8'); //读取数据
        if (temp2 != null) {

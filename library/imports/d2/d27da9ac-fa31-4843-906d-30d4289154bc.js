"use strict";
cc._RF.push(module, 'd27dams+jFIQ5BtMNQokVS8', 'IETy10_10');
// script/类别10人/IETy10_10.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('mid10'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('mselect10'); //读取数据
        if (temp2 != null) {

"use strict";
cc._RF.push(module, 'a9692+xaxtEIKxVCVx/UA/Z', 'IET25_23 ');
// script/团队25人/IET25_23 .js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid23'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect23'); //读取数据
        if (temp2 != null) {

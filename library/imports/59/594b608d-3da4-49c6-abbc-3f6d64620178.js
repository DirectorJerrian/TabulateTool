"use strict";
cc._RF.push(module, '594b6CNPaRJxqu8P21kYgF4', 'IET25_15');
// script/团队25人/IET25_15.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid15'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect15'); //读取数据
        if (temp2 != null) {

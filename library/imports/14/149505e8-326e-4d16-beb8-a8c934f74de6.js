"use strict";
cc._RF.push(module, '14950XoMm5NFr64qMk0903m', 'IET25_4');
// script/团队25人/IET25_4.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid4'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect4'); //读取数据
        if (temp2 != null) {

"use strict";
cc._RF.push(module, '01a0ezl/UlHr4BUKmbzjoTA', 'IETy10_15');
// script/类别10人/IETy10_15.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('mid15'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('mselect15'); //读取数据
        if (temp2 != null) {

"use strict";
cc._RF.push(module, 'c0b47e9L5ZLk5Y0/iDIWhB/', 'IET25_18');
// script/团队25人/IET25_18.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid18'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect18'); //读取数据
        if (temp2 != null) {

"use strict";
cc._RF.push(module, '3de31ATNEFEEoXD26CDpVth', 'IET25_6');
// script/团队25人/IET25_6.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid6'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect6'); //读取数据
        if (temp2 != null) {

"use strict";
cc._RF.push(module, 'eb3bfTyhvlADrWcL4Ru0Jcm', 'IET10_8');
// script/团队10人/IET10_8.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('id8'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('select8'); //读取数据
        if (temp2 != null) {

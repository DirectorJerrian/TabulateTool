"use strict";
cc._RF.push(module, 'bd6a4eBiHxHf5hg/t+k6xIQ', 'IET25_12');
// script/团队25人/IET25_12.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid12'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect12'); //读取数据
        if (temp2 != null) {

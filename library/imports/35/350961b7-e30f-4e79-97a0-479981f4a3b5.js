"use strict";
cc._RF.push(module, '35096G34w9OeZegR5mB9KO1', 'IETy10_4');
// script/类别10人/IETy10_4.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('mid4'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('mselect4'); //读取数据
        if (temp2 != null) {

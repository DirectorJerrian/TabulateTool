"use strict";
cc._RF.push(module, '9c6f0kmiupC3Z8cjCQEF68S', 'IET10_1');
// script/团队10人/IET10_1.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('id1'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('select1'); //读取数据
        if (temp2 != null) {

"use strict";
cc._RF.push(module, '9c7bbt+t9xBn6H6D7oKlU8s', 'IET25_20');
// script/团队25人/IET25_20.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid20'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect20'); //读取数据
        if (temp2 != null) {

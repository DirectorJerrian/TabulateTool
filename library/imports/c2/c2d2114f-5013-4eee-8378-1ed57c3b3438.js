"use strict";
cc._RF.push(module, 'c2d21FPUBNO7oN4HtV8OzQ4', 'IETy10_13');
// script/类别10人/IETy10_13.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('mid13'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('mselect13'); //读取数据
        if (temp2 != null) {

"use strict";
cc._RF.push(module, '99cb04p6KNHdIUrnBoBq82k', 'IETy10_2');
// script/类别10人/IETy10_2.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('mid2'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('mselect2'); //读取数据
        if (temp2 != null) {

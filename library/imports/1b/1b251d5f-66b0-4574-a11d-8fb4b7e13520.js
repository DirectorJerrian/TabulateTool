"use strict";
cc._RF.push(module, '1b2511fZrBFdKEdj7S34TUg', 'IET25_7');
// script/团队25人/IET25_7.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid7'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect7'); //读取数据
        if (temp2 != null) {

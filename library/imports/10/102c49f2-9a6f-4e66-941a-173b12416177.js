"use strict";
cc._RF.push(module, '102c4nymm9OZpQaFzsSQWF3', 'IET25_21');
// script/团队25人/IET25_21.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid21'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect21'); //读取数据
        if (temp2 != null) {

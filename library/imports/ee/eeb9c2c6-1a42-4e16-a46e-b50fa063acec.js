"use strict";
cc._RF.push(module, 'eeb9cLGGkJOFqRutQ+gY6zs', 'IETy10_6');
// script/类别10人/IETy10_6.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('mid6'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('mselect6'); //读取数据
        if (temp2 != null) {

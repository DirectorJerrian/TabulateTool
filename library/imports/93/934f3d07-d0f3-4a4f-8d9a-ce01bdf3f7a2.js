"use strict";
cc._RF.push(module, '934f30H0PNKT42azgG98/ei', 'IETy10_7');
// script/类别10人/IETy10_7.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('mid7'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('mselect7'); //读取数据
        if (temp2 != null) {

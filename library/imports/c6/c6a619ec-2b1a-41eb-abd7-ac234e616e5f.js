"use strict";
cc._RF.push(module, 'c6a61nsKxpB66vXrCNOYW5f', 'inputEnd');
// script/inputEnd.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('id'); //读取数据
        if (temp1 != null) {
            this.self.children[1].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('select'); //读取数据
        if (temp2 != null) {

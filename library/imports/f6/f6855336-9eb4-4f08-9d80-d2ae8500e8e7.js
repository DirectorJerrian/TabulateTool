"use strict";
cc._RF.push(module, 'f6855M2nrRPCJ2A0q6FAOjn', 'IET10_3');
// script/团队10人/IET10_3.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('id3'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('select3'); //读取数据
        if (temp2 != null) {

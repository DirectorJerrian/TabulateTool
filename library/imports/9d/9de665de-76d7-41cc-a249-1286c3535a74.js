"use strict";
cc._RF.push(module, '9de66XedtdBzKJJEobDU1p0', 'IET25_16');
// script/团队25人/IET25_16.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid16'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect16'); //读取数据
        if (temp2 != null) {

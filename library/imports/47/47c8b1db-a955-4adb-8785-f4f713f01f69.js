"use strict";
cc._RF.push(module, '47c8bHbqVVK24eF9PcT8B9p', 'IET25_14');
// script/团队25人/IET25_14.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid14'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect14'); //读取数据
        if (temp2 != null) {

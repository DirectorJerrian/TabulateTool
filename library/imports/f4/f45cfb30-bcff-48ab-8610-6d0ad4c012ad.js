"use strict";
cc._RF.push(module, 'f45cfswvP9Iq4YQbQrUwBKt', 'IET25_24');
// script/团队25人/IET25_24.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid24'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect24'); //读取数据
        if (temp2 != null) {

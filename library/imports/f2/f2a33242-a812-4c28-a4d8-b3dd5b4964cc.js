"use strict";
cc._RF.push(module, 'f2a33JCqBJMKKTYs91bSWTM', 'IETy10_9');
// script/类别10人/IETy10_9.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('mid9'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('mselect9'); //读取数据
        if (temp2 != null) {

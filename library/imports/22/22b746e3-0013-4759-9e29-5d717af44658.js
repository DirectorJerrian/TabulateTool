"use strict";
cc._RF.push(module, '22b74bjABNHWZ4pXXF69EZY', 'IET10_9');
// script/团队10人/IET10_9.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('id9'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('select9'); //读取数据
        if (temp2 != null) {

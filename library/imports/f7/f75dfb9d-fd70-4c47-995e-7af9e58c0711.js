"use strict";
cc._RF.push(module, 'f75dfud/XBMR5leevnljAcR', 'IET25_10');
// script/团队25人/IET25_10.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid10'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect10'); //读取数据
        if (temp2 != null) {

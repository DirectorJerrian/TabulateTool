"use strict";
cc._RF.push(module, 'f740eXW4ENNsboghlynkBQj', 'IET25_5');
// script/团队25人/IET25_5.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid5'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect5'); //读取数据
        if (temp2 != null) {

"use strict";
cc._RF.push(module, '03b196S2lNEfoXkoFGviTUs', 'IET25_13');
// script/团队25人/IET25_13.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('nid13'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('nselect13'); //读取数据
        if (temp2 != null) {

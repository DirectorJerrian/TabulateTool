"use strict";
cc._RF.push(module, '442d5M4mrVPK7oVZNhWysfY', 'IETy10_5');
// script/类别10人/IETy10_5.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('mid5'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('mselect5'); //读取数据
        if (temp2 != null) {

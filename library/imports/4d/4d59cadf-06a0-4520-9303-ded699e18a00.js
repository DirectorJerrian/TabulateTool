"use strict";
cc._RF.push(module, '4d59crfBqBFIJMD3taZ4YoA', 'IETy10_12');
// script/类别10人/IETy10_12.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        var temp1 = cc.sys.localStorage.getItem('mid12'); //读取数据
        if (temp1 != null) {
            this.self.children[2].getComponent(cc.Label).string = temp1;
        }
        var temp2 = cc.sys.localStorage.getItem('mselect12'); //读取数据
        if (temp2 != null) {
